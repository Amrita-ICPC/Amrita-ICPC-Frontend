...
import type { StudentContestStatusResponse } from './studentContestStatusResponse';

export interface APIResponseStudentContestStatusResponse {
  success?: boolean;
  status?: number;
  message?: string;
  data?: StudentContestStatusResponse | null;
