...
import type { StudentContestDetailsResponse } from './studentContestDetailsResponse';

export interface APIResponseStudentContestDetailsResponse {
  success?: boolean;
  status?: number;
  message?: string;
  data?: StudentContestDetailsResponse | null;
