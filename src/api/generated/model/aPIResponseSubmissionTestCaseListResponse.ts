...
import type { SubmissionTestCaseListResponse } from './submissionTestCaseListResponse';

export interface APIResponseSubmissionTestCaseListResponse {
  success?: boolean;
  status?: number;
  message?: string;
  data?: SubmissionTestCaseListResponse | null;
