...
import type { StudentUserSearchResponse } from './studentUserSearchResponse';

export interface APIResponseListStudentUserSearchResponse {
  success?: boolean;
  status?: number;
  message?: string;
  data?: StudentUserSearchResponse[] | null;
