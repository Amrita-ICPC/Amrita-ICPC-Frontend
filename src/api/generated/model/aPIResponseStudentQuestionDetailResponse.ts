...
import type { StudentQuestionDetailResponse } from './studentQuestionDetailResponse';

export interface APIResponseStudentQuestionDetailResponse {
  success?: boolean;
  status?: number;
  message?: string;
  data?: StudentQuestionDetailResponse | null;
