...
import type { SubmissionDetailResponse } from './submissionDetailResponse';

export interface APIResponseSubmissionDetailResponse {
  success?: boolean;
  status?: number;
  message?: string;
  data?: SubmissionDetailResponse | null;
