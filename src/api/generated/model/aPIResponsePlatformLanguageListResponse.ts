...
import type { PlatformLanguageListResponse } from './platformLanguageListResponse';

export interface APIResponsePlatformLanguageListResponse {
  success?: boolean;
  status?: number;
  message?: string;
  data?: PlatformLanguageListResponse | null;
