...
import type { StudentContestListResponse } from './studentContestListResponse';

export interface APIResponseStudentContestListResponse {
  success?: boolean;
  status?: number;
  message?: string;
  data?: StudentContestListResponse | null;
