 ...
 */
import type { ContestTeamProgressResponse } from './contestTeamProgressResponse';
import type { MetaResponse } from './metaResponse';
import type { PaginationResponse } from './paginationResponse';

export interface APIResponseContestTeamProgressResponse {
  success?: boolean;
  status?: number;
  message?: string;
  data?: ContestTeamProgressResponse | null;
