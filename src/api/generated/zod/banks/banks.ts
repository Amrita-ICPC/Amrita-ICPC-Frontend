...
export const CreateBankApiV1BanksPostBody = zod
    .object({
        name: zod.string().min(1).max(createBankApiV1BanksPostBodyNameMax).describe("Bank name"),
        description: zod
            .union([zod.string().max(createBankApiV1BanksPostBodyDescriptionOneMax), zod.null()])
            .optional()
            .describe("Bank description"),
    })
    .describe(
...
export const GetAllBanksApiV1BanksGetQueryParams = zod.object({
    page: zod
        .number()
        .min(1)
        .default(getAllBanksApiV1BanksGetQueryPageDefault)
        .describe("Page number (starts from 1)"),
    page_size: zod
        .number()
        .min(1)
        .max(getAllBanksApiV1BanksGetQueryPageSizeMax)
        .default(getAllBanksApiV1BanksGetQueryPageSizeDefault)
        .describe("Number of banks per page"),
});
                ...
                zod
                    .object({
                        name: zod
                            .string()
                            .min(1)
                            .max(getAllBanksApiV1BanksGetResponseDataOneItemNameMax)
                            .describe("Bank name"),
                        description: zod
                            .union([
                                zod
                                    .string()
                                    .max(
                                        getAllBanksApiV1BanksGetResponseDataOneItemDescriptionOneMax,
                                    ),
                                zod.null(),
                            ])
                            .optional()
                        ...
                        updated_at: zod.iso.datetime({}).describe("Last update time"),
                    })
                    .describe(
...
export const GetDeletedBanksApiV1BanksDeletedGetQueryParams = zod.object({
    page: zod
        .number()
        .min(1)
        .default(getDeletedBanksApiV1BanksDeletedGetQueryPageDefault)
        .describe("Page number (starts from 1)"),
    page_size: zod
        .number()
        .min(1)
        .max(getDeletedBanksApiV1BanksDeletedGetQueryPageSizeMax)
        .default(getDeletedBanksApiV1BanksDeletedGetQueryPageSizeDefault)
        .describe("Number of banks per page"),
});
                ...
                zod
                    .object({
                        name: zod
                            .string()
                            .min(1)
                            .max(getDeletedBanksApiV1BanksDeletedGetResponseDataOneItemNameMax)
                            .describe("Bank name"),
                        description: zod
                            .union([
                                zod
                                    .string()
                                    .max(
                                        getDeletedBanksApiV1BanksDeletedGetResponseDataOneItemDescriptionOneMax,
                                    ),
                                zod.null(),
                            ])
                            .optional()
            ...
            zod
                .object({
                    name: zod
                        .string()
                        .min(1)
                        .max(getBankApiV1BanksBankIdGetResponseDataOneNameMax)
                        .describe("Bank name"),
                    description: zod
                        .union([
                            zod
                                .string()
                                .max(getBankApiV1BanksBankIdGetResponseDataOneDescriptionOneMax),
                            zod.null(),
                        ])
                        .optional()
                        .describe("Bank description"),
                    ...
                    questions: zod
                        .array(
                            zod.object({
                                ...
                                time_limit_ms: zod
                                    .number()
                                    .gt(
                                        getBankApiV1BanksBankIdGetResponseDataOneQuestionsItemTimeLimitMsExclusiveMin,
                                    )
                                    .describe("Time limit in milliseconds"),
                                memory_limit_mb: zod
                                    .number()
                                    .gt(
                                        getBankApiV1BanksBankIdGetResponseDataOneQuestionsItemMemoryLimitMbExclusiveMin,
                                    )
                        ...
                        .default(getBankApiV1BanksBankIdGetResponseDataOneQuestionsDefault)
                        .describe("List of questions in the bank"),
                    shares: zod
                        .array(
                            zod
                                .object({
                                    ...
                                    permission: zod
                                        ...
                                        .describe("Permission level granted"),
                                })
                                .describe(
                                    "Base schema for representing a bank share configuration.\n\nDescribes what permission level a specific user has on a bank.",
                                ),
                        )
                        .default(getBankApiV1BanksBankIdGetResponseDataOneSharesDefault)
                        .describe("List of users the bank is shared with"),
                })
                .describe(
...
export const UpdateBankApiV1BanksBankIdPatchBody = zod
    .object({
        name: zod
            .union([zod.string().max(updateBankApiV1BanksBankIdPatchBodyNameOneMax), zod.null()])
            .optional()
            .describe("Bank name"),
        description: zod
            .union([
                zod.string().max(updateBankApiV1BanksBankIdPatchBodyDescriptionOneMax),
                zod.null(),
            ])
            .optional()
            .describe("Bank description"),
...
export const SoftDeleteBankApiV1BanksBankIdSoftDeleteDeleteResponse = zod.object({
    success: zod
        .boolean()
        .default(softDeleteBankApiV1BanksBankIdSoftDeleteDeleteResponseSuccessDefault),
    status: zod
        .number()
        .default(softDeleteBankApiV1BanksBankIdSoftDeleteDeleteResponseStatusDefault),
    message: zod
        .string()
        .default(softDeleteBankApiV1BanksBankIdSoftDeleteDeleteResponseMessageDefault),
    data: zod.union([zod.unknown(), zod.null()]).optional(),
    pagination: zod
        .union([
            zod.object({
            ...
            zod
                .object({
                    name: zod
                        .string()
                        .min(1)
                        .max(restoreBankApiV1BanksBankIdRestorePostResponseDataOneNameMax)
                        .describe("Bank name"),
                    description: zod
                        .union([
                            zod
                                .string()
                                .max(
                                    restoreBankApiV1BanksBankIdRestorePostResponseDataOneDescriptionOneMax,
                                ),
                            zod.null(),
                        ])
                        .optional()
...
export const ShareBankApiV1BanksBankIdSharePostBody = zod
    .object({
        shares: zod
            .array(
                zod
                    .object({
                        ...
                        permission: zod
                            .enum(["read", "edit", "owner"])
                            .default(
                                shareBankApiV1BanksBankIdSharePostBodySharesItemPermissionDefault,
                            )
            ...
            .describe("List of users to share with"),
    })
    .describe(
...
export const UnshareBankApiV1BanksBankIdUnsharePostBody = zod
    .object({
