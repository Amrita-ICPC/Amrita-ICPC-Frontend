...
import type { ExceptionResponse, UserProfile, UserSyncResponse } from "../model";
 ...
 * @summary Get Users
 */
export const getUsersApiV1UsersGet = (signal?: AbortSignal) => {
    return axiosWithAuth<unknown>({ url: `/api/v1/users/`, method: "GET", signal });
};
...
>(options?: {
    query?: Partial<
        UseQueryOptions<Awaited<ReturnType<typeof getUsersApiV1UsersGet>>, TError, TData>
    >;
}) => {
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getUsersApiV1UsersGet>>> = ({
        signal,
    }) => getUsersApiV1UsersGet(signal);
...
export function useGetUsersApiV1UsersGet<
    TData = Awaited<ReturnType<typeof getUsersApiV1UsersGet>>,
    TError = ExceptionResponse,
>(
    options: {
 ...
 * @summary Create User
 */
export const createUserApiV1UsersPost = (signal?: AbortSignal) => {
    return axiosWithAuth<unknown>({ url: `/api/v1/users/`, method: "POST", signal });
};
...
> => {
    ...
    const mutationFn: MutationFunction<
        ...
        void
    > = () => {
        return createUserApiV1UsersPost();
    };
 ...
 * @summary Create User
 */
export const useCreateUserApiV1UsersPost = <TError = ExceptionResponse, TContext = unknown>(
    options?: {
        mutation?: UseMutationOptions<
            Awaited<ReturnType<typeof createUserApiV1UsersPost>>,
            TError,
...
export const getMeApiV1UsersMeGet = (signal?: AbortSignal) => {
    return axiosWithAuth<UserProfile>({ url: `/api/v1/users/me`, method: "GET", signal });
};
 ...
 */
export const syncKeycloakUsersApiV1UsersSyncKeycloakUsersPost = (signal?: AbortSignal) => {
...
export const getSyncKeycloakUsersApiV1UsersSyncKeycloakUsersPostMutationOptions = <
    TError = ExceptionResponse,
    TContext = unknown,
>(options?: {
    mutation?: UseMutationOptions<
...
export type SyncKeycloakUsersApiV1UsersSyncKeycloakUsersPostMutationResult = NonNullable<
    Awaited<ReturnType<typeof syncKeycloakUsersApiV1UsersSyncKeycloakUsersPost>>
>;
 ...
 * @summary Sync Keycloak Users
 */
export const useSyncKeycloakUsersApiV1UsersSyncKeycloakUsersPost = <
    TError = ExceptionResponse,
    TContext = unknown,
>(
    options?: {
...
> => {
    return useMutation(
        getSyncKeycloakUsersApiV1UsersSyncKeycloakUsersPostMutationOptions(options),
        queryClient,
    );
};
