                ...
                <div className="relative z-10 flex flex-col gap-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-lg text-muted-foreground font-medium max-w-2xl">
                            Select specific questions from{" "}
                            <span className="text-primary font-bold">
                                {sourceBank?.name || "source bank"}
                            </span>{" "}
                            to clone into your current bank.
                        </p>
                    </div>
            ...
            <div className="space-y-4">
                ...
                >
                    <div className="rounded-xl border border-border/60 bg-card/50 backdrop-blur-md overflow-hidden shadow-xl">
                        <div className="grid grid-cols-[48px_1fr_120px_200px] items-center gap-4 px-6 py-4 border-b border-border/60 bg-muted/50 text-[11px] font-bold uppercase tracking-widest text-muted-foreground">
                        ...
                        >
                            {questions && questions.length > 0 ? (
                                questions.map((question) => (
                                    <div
                                        key={question.id}
                                        className="grid grid-cols-[48px_1fr_120px_200px] items-center gap-4 px-6 py-4 hover:bg-muted/30 transition-colors group"
                                    >
                                        <div className="flex justify-center">
                                            <Checkbox
