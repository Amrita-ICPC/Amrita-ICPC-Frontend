...
export function BankList() {
    ...
    return (
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            {/* Toolbar Section */}
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-between w-full bg-card border border-border/40 p-4 rounded-2xl shadow-sm">
                <div className="relative w-full max-w-md group">
                    ...
                    <Input
                        ...
                        className="pl-10 h-10 bg-background/50 border-border/60 focus-visible:ring-primary/30 focus-visible:border-primary/50 transition-all rounded-lg shadow-sm text-sm"
                ...
                <div className="flex items-center gap-3 w-full sm:w-auto shrink-0 justify-between sm:justify-end">
                    ...
                    >
                        <SelectTrigger className="w-[180px] sm:w-[220px] h-10 rounded-lg bg-background/50 border-border/60 shadow-sm text-sm font-medium">
            ...
            {isLoading ? (
                view === "grid" ? (
                    <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3 items-start content-start">
                        {Array.from({ length: 6 }).map((_, i) => (
                            <Skeleton
                                key={i}
                                className="h-56 rounded-2xl border border-border/40"
                            />
                        ))}
                    </div>
                ) : (
                ...
                <div className="flex min-h-[300px] flex-col items-center justify-center gap-3 rounded-2xl border border-destructive/30 bg-destructive/5 p-6 text-center shadow-sm">
                ...
                <div className="flex min-h-[300px] flex-col items-center justify-center gap-4 rounded-2xl border border-dashed border-border/60 bg-muted/5 p-6 text-center shadow-sm">
