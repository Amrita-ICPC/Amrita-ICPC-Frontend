...
export function TeamSubmissionBreakdownChart({ analytics }: TeamSubmissionBreakdownChartProps) {
    ...
    return (
        <Card className="h-full border-border/70 bg-card shadow-sm">
            <CardHeader className="pb-2">
                ...
                <CardDescription>Verdict distribution for this team.</CardDescription>
            </CardHeader>
                ...
                {totalSubmissions === 0 ? (
                    <div className="flex min-h-[260px] flex-col items-center justify-center rounded-lg border border-dashed border-border/70 bg-muted/20 p-6 text-center">
                        ...
                        <p className="mt-1 text-xs text-muted-foreground">
                            Verdict analytics will appear after this team submits solutions.
                        </p>
                    </div>
                ) : (
                    <>
